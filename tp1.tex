...
\tadAxioma{adyacentes?(pos1, pos2)}{ (pos1.y = pos2.y + 1 $\land$ pos1.x = pos2.x)
     $\lor$ (pos2.y = pos1.y + 1 $\land$ pos1.x = pos2.x)    
     $\lor$ (pos1.x = pos2.x + 1 $\land$ pos1.y = pos2.y)    
     $\lor$ (pos2.x = pos1.x + 1 $\land$ pos1.y = pos2.y)        
}
