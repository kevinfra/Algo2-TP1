...
\tadAxioma{losMasVigilantes(asshole, numeroDeCapturas)}{ \IF $\#$claves(asshole) $= 1$
	THEN DameUno(claves(asshole))
	ELSE{
	 \- \IF capturas(DameUno(claves(asshole))) $=$ numeroDeCapturas THEN Ag(DameUno(claves(asshole)), losMasVigilantes(borrar(DameUno(claves(asshole)), asshole), numeroDeCapturas))
	 	 ELSE losMasVigilantes(borrar(DameUno(claves(asshole)), asshole), numeroDeCapturas)
	 	 FI
	}
	FI
