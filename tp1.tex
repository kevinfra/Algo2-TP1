...
\tadAxioma{actualizarAs(pos,dic,c)}{
    ...
    ELSE {
        ...
        ELSE{
            ...
            ELSE premiarYSancionar(asSancPrem(\\ asParaModificar(periferia(hAtrapados\\ (posContiguas(pos,grilla(c)),c),c),c),\\ asParaModificar(periferia(eAtrapados\\ (posContiguas(pos,grilla(c)),c),c),c)), c)
            FI
        }
        FI
    }
