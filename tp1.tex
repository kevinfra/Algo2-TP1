...
\tadOperacion{crearCampus}{grilla/g, dicc(placa, as)/ass}{campus}{posValidas?(g, ass) $\land$ posSinObstaculos?(g, ass) $\land$ sinCapturas?(ass) $\land$ sinSanciones?(ass)}
...
\tadOperacion{iterarValidas}{grilla, dicc(placa, as), conj(placa)}{bool}{}
\tadOperacion{posValida?}{grilla, posicion}{bool}{}
\tadOperacion{posSinObstaculos?}{grilla, dicc(placa, as)}{bool}{}
\tadOperacion{iterarSinObs}{grilla, dicc(placa, as), conj(placa)}{bool}{}
...
\tadAxioma{posValidas?(g, ass)}{iterarValidas(g, ass, claves(ass))}
\tadAxioma{iterarValidas(g, ass, claves)}{
    \IF $\emptyset$?(claves) THEN true
    ELSE { 
    \-\- \IF posValida?(g, posicion(obtener(ass, dameUno(claves)))) THEN iterarValidas(g, ass, sinUno(claves))
    \-\- ELSE false
    \-\- FI
    }
    FI 
...
\tadAxioma{posSinObstaculos?(g, ass)}{iterarSinObs(g, ass, claves(ass))}
\tadAxioma{iterarSinObs(g, ass, claves)}{
    \IF $\emptyset$?(claves) THEN true
    ELSE { 
    \-\- \IF posSinObstaculo?(g, posicion(obtener(ass, dameUno(claves)))) THEN iterarSinObs(g, ass, sinUno(claves))
    \-\- ELSE false
    \-\- FI
    }
    FI 
