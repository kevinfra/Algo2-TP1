...
\tadAxioma{asshole(movAS(c, p))}{ \IF Obtener(p,asshole(c)).sanciones $\geq3$ 
    THEN asshole(c)
    ELSE {
...
\tadAxioma{posAS(c, p)}{Obtener(p,asshole(c)).poscion}
...
actualizarAs(nuevapos, definir(p,\\ (nuevapos, Obtener(p,asshole(c)).capturas,\\ Obtener(p,asshole(c)).sanciones), asshole(c)),c)
}
...
\tadAxioma{premiarAs(conjAs,c)}{
	...
	ELSE definir(dameUno(conjAs),\\ (Obtener(dameUno(conjAs),asshole(c)).posicion,\\ Obtener(dameUno(conjAs),asshole(c)).capturas +1,\\ Obtener(dameUno(conjAs),asshole(c)).sanciones),\\ premiarAs(sinUno(conjAs),c))
	FI
}
...
\tadAxioma{distanciaTaxista(pos,posPers)}{ distancia(pos.x, posPers.x) - distancia(pos.y, posPers.y)
}
...
\tadAxioma{sancionarAs(conjAs,c)}{ \IF $\emptyset$?(conjAs) THEN asshole(c)
	ELSE definir(dameUno(conjAs),\\ (Obtener(dameUno(conjAs),asshole(c)).posicion,\\ Obtener(dameUno(conjAs),asshole(c)).capturas,\\  Obtener(dameUno(conjAs),asshole(c)).sanciones +1),\\ sancionarAs(sinUno(conjAs),c))
	FI
}
...
\tadAxioma{premiarYSancionar(conjP,c)}{ \IF $\emptyset$?(conjAs) THEN asshole(c)
	ELSE{
		...
		THEN definir(dameUno(conjP),\\ (Obtener($\pi_1$dameUno(conjP),asshole(c).posicion,\\ Obtener($\pi_1$dameUno(conjP),asshole(c).capturas +1,\\ Obtener($\pi_1$dameUno(conjP),asshole(c)).sanciones),\\  premiarYSancionar(sinUno(conjP),c))
		ELSE definir(dameUno(conjP),\\ (Obtener($\pi_1$dameUno(conjP),asshole(c)).posicion,\\  Obtener($\pi_1$dameUno(conjP),asshole(c)).capturas,\\ Obtener($\pi_1$dameUno(conjP),asshole(c)).sanciones+1,\\  premiarYSancionar(sinUno(conjP),c))
		FI
	}
	FI
}
