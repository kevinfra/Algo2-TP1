...
\tadAxioma{esEntrada?(c,pos)}{ $\pi_2$(pos) = 0 $\lor$ $\pi_2$(pos) = alto(grilla(c)) - 1 
}

\tadAxioma{esAS?(c, p)}{ def?(p,asshole(c))
}

\tadAxioma{adyacentes?(pos1, pos2)}{ ($\pi_2$(pos1) = $\pi_2$(pos2) + 1 $\land$ $\pi_1$(pos1) = $\pi_1$(pos2))
     $\lor$ ($\pi_2$(pos2) = $\pi_2$(pos1) + 1 $\land$ $\pi_1$(pos1) = $\pi_1$(pos2))    
     $\lor$ ($\pi_1$(pos1) = $\pi_1$(pos2) + 1 $\land$ $\pi_2$(pos1) = $\pi_2$(pos2))    
     $\lor$ ($\pi_1$(pos2) = $\pi_1$(pos1) + 1 $\land$ $\pi_2$(pos1) = $\pi_2$(pos2))        
}
