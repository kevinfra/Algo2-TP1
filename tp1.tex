...
\tadAlinearAxiomas{hippies(movEstudiante(c, ini, fin))}
...
\tadAlinearAxiomas{esAtrapadoE?(posE,conjcont,c)}
...
\tadAlinearAxiomas{placaDelAs(pos,conjplacas,dic)}
...
\tadAxioma{asSancPrem(conjPrem,conjSanc,c)}{
    ...
    ELSE{
        ...
        THEN Ag(\\ (placaDelAs(dameUno(conjPrem),\\ claves(agentes(c)),agentes(c)),false),\\ asSancPrem(sinUno(conjPrem),conjSanc,c))
        ELSE{
            \IF $\emptyset$?(conjPrem)$\land \neg \emptyset$?(conjSanc)
            THEN Ag(\\ (placaDelAs(dameUno(conjSanc),\\ claves(agentes(c)),agentes(c)),false),\\ asSancPrem(conjPrem,sinUno(conjSanc),c))
            ELSE{
                    Ag((placaDelAs(dameUno(conjPrem),\\ claves(agentes(c)),agentes(c)),false), Ag((placaDelAs(dameUno(conjSanc),\\ claves(agentes(c)),agentes(c)),false),\\ asSancPrem(sinUno(conjPrem),sinUno(conjSanc),c)))
            }
            FI
        }
        FI
